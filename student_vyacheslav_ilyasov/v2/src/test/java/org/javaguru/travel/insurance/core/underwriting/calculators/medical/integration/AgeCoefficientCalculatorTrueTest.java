...
@SpringBootTest(properties = {"age.coeficient.enable=true"})
class AgeCoefficientCalculatorTrueTest {
    ...
    public void shouldReturnResult() {
        ...
        assertTrue(BigDecimal.valueOf(1.1).compareTo(ageCoefficientCalculator.getCoefficient(agreementDTO,personDTO)) == 0);
    }
}