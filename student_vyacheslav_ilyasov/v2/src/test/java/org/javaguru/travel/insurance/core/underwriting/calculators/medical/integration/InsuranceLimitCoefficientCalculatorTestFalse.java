...
class InsuranceLimitCoefficientCalculatorTestFalse {
    ...
    public void shouldReturnResult() {
        ...
        assertEquals(BigDecimal.ONE,insuranceLimitCoefficientCalculator.getCoefficient(agreementDTO,personDTO));
    }
